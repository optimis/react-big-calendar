  ...
  function Agenda() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.renderDay = function (day, events, dayKey) {
      ...
      return events.map(function (event, idx) {
        ...
        var first = idx === 0 ? _react2.default.createElement('td', { rowSpan: events.length, className: 'rbc-agenda-date-cell' }, DateComponent ? _react2.default.createElement(DateComponent, { day: day, label: dateLabel }) : dateLabel) : false;

        var title = (0, _accessors.accessor)(event, titleAccessor);

        return _react2.default.createElement('tr', { key: dayKey + '_' + idx }, first, _react2.default.createElement('td', { className: 'rbc-agenda-time-cell' }, _this.timeRangeLabel(day, event)), _react2.default.createElement('td', { className: 'rbc-agenda-event-cell' }, EventComponent ? _react2.default.createElement(EventComponent, { event: event, title: title }) : title));
      }, []);
      ...
      return _react2.default.createElement('span', { className: labelClass.trim() }, TimeComponent ? _react2.default.createElement(TimeComponent, { event: event, label: label }) : label);
