...
var MonthView = function (_React$Component) {
  ...
  MonthView.prototype.render = function render() {
    ...
    return _react2.default.createElement('div', { className: (0, _classnames2.default)('rbc-month-view', className) }, _react2.default.createElement('div', { className: 'rbc-row rbc-month-header' }, this.renderHeaders(weeks[0], weekdayFormat, culture)), weeks.map(function (week, idx) {
  ...
  MonthView.prototype.renderHeaders = function renderHeaders(row, format, culture) {
    ...
    return _dates2.default.range(first, last, 'day').map(function (day, idx) {
      return _react2.default.createElement('div', { key: 'header_' + idx, className: 'rbc-header', style: (0, _eventLevels.segStyle)(1, 7) }, _react2.default.createElement(HeaderComponent, {
        date: day,
